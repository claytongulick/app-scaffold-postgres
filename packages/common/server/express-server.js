 ...
 * @returns 
 */
export default function ExpressServer(logger, routers, config, middleware) {
    program
    ...
    */
    ...
    //this is to support *.somedomain.com as well as whitelabeled domains
    app.use((req, res, next) => {
        try {
            ...
            let session_options = {
                ...
                name: process.env.CLIENT_ID + '.sid',
    ...
    for (let router of routers) {
        ...
        app.use(router.__mount_path || config.mount_path || '/', router);
    }
